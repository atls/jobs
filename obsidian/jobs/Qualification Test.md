...
Этап подтверждения [[Qualification | квалификации]] и [[Applicant Grade  | грейда]]. 

В более узком смысле, это репозиторий, где у [[Applicant | соискателя]] лежит [[Test Task | тестовое задание]]. Задача [[Applicant | соискателя]] решить это тестовое задание, чтобы подтвердить заявленные квалификацию и грейд. 
...
Соискатель возвращается на этап [[Info collector | сборщика информации]], конкретно в целевой участок — пересмотреть свою [[Qualification | квалификацию]] и [[Applicant Grade | грейд]].
