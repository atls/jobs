...
Этап где соискатель должен выполнить тестовое задание в репозитории. Исходя из того, какую [[Qualification | квалификацию]] и какой [[Grade | грейд]] выбрал ранее соискатель, он получает соответствующее [[TestTask | тестовое задание]] для выполнения. 
